        ...
        <>
          ...
          <div className="fixed inset-0 z-50 flex items-center justify-center p-4 pointer-events-none">
            <motion.div
              ...
              className="w-full max-w-md bg-[#111827]/90 border border-[#8B5CF6]/30 shadow-[0_0_40px_rgba(139,92,246,0.3)] rounded-3xl pointer-events-auto overflow-hidden relative"
            >
              ...
              <div className="flex items-center justify-between p-6 border-b border-[#8B5CF6]/20">
                <h2 className="text-xl font-orbitron font-bold text-[#F9FAFB] glow-text leading-tight">
                  {isShareMode ? "Share Link" : "Never miss a drop."}
                </h2>
                <button
                  onClick={onClose}
                  ...
                  <form onSubmit={handleSubmit} className="space-y-5">
                    ...
                    <div className="space-y-2">
                      ...
                      <input
                        ...
                        className="w-full px-5 py-4 transition-all border rounded-xl bg-[#070B14] border-white/10 focus:outline-none focus:border-[#06B6D4] focus:shadow-[0_0_15px_rgba(6,182,212,0.3)] text-[#F9FAFB] text-sm placeholder:text-[#9CA3AF]"
                      />
                    </div>
                      ...
                      className={cn(
                        ...
                        status === "loading"
                          ...
                          : (!isShareMode && action === "unsubscribe")
                            ? "bg-[#EF4444] text-[#F9FAFB] hover:bg-white hover:text-[#070B14] shadow-[0_0_15px_rgba(239,68,68,0.3)]"
                            : "bg-[#06B6D4] text-[#070B14] hover:bg-white hover:shadow-[0_0_20px_rgba(6,182,212,0.5)] shadow-[0_0_15px_rgba(6,182,212,0.4)]"
                      )}
                    >
                      {status === "loading" ? (
                        <motion.div
                        ...
                        <>
                          ...
                          {isShareMode ? "Transmit" : action === "subscribe" ? "Connect" : "Disconnect"}
                        </>
                      )}
                    </button>
                    {!isShareMode && (

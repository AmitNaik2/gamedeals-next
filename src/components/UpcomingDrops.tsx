...
export function UpcomingDrops({ deals, onViewAll }: { deals: GameDeal[], onViewAll?: () => void }) {
  ...
  return (
    <div className="bg-[#111827]/80 backdrop-blur-xl border border-[#EC4899]/30 rounded-3xl p-5 overflow-hidden mt-6 relative group shadow-[0_0_20px_rgba(236,72,153,0.1)]">
      ...
      <div className="flex items-center justify-between mb-4 relative z-10">
        <div className="flex items-center gap-2">
          ...
          <h3 className="text-[11px] font-orbitron font-bold uppercase tracking-[0.2em] text-[#F9FAFB] glow-text">Upcoming Drops</h3>
        </div>
      </div>
          ...
          return (
            ...
            >
              ...
              <div className="text-right">
                <span className="text-[11px] font-mono font-bold text-[#EC4899] block whitespace-nowrap bg-[#EC4899]/10 px-2 py-0.5 rounded border border-[#EC4899]/20">FREE</span>
              </div>
            </motion.div>
          );
        })}
      ...
      {onViewAll && (
        <button onClick={onViewAll} type="button" className="w-full mt-4 py-3 border border-[#EC4899]/30 rounded-xl text-[10px] font-bold uppercase tracking-widest text-[#EC4899] hover:text-[#070B14] hover:bg-[#EC4899] transition-all flex items-center justify-center gap-2 shadow-[0_0_10px_rgba(236,72,153,0.2)]">

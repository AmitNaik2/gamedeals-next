...
// Set up Nodemailer transporter
  ...
  app.get("/api/upcoming-free-games", async (req, res) => {
    try {
      ...
      const formatted = upcoming.map((item: any) => {
        ...
        const imageObj = item.keyImages.find((img: any) => img.type === "OfferImageWide") || item.keyImages.find((img: any) => img.type === "Thumbnail") || item.keyImages[0];
